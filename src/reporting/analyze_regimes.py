...
regime_stats = analysis_df.groupby('regime')['daily_return'].agg(['mean', 'std', 'count']).rename(columns={'mean': 'Mean Daily Return', 'std': 'Daily Volatility', 'count': 'Days in Regime'})
